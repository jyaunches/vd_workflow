...
> This plugin implements the workflows described in [Verification-Driven Agentic Coding](https://jyaunches.github.io/blog/verification-driven-agentic-workflows). Read that article for the full philosophy; this README covers practical usage.
...
Edit `PATTERNS.md` to tune verification to your team's standards. See the [blog article appendix](https://jyaunches.github.io/blog/verification-driven-agentic-workflows#appendix-tuning-your-verification-criteria) for examples.
